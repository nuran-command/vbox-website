...
export default function Clients() {
  ...
  const clients = [
    {
      name: t('clients.name.barys'),
      image: '/images/barys.png'
    },
    {
      name: t('clients.name.mercedes'),
      image: '/images/Mercedes-Benz-Logo.png'
    },
    {
      name: t('clients.name.huawei'),
      image: '/images/Huawei_Standard_logo.svg.png'
    },
    {
      name: t('clients.name.mechta'),
      image: '/images/Mechta.png'
    },
    {
      name: t('clients.name.sergek'),
      image: '/images/Sergek.jpg'
    },
    {
      name: t('clients.name.nu'),
      image: '/images/nu_logo.png'
    },
    {
      name: t('clients.name.tsarka'),
      image: '/images/Tsarka.jpeg'
    },
    {
      name: t('clients.name.trustme'),
      image: '/images/Trust_me.png'
    },
    {
      name: t('clients.name.technopark'),
      image: '/images/technopark.png'
    },
    {
      name: t('clients.name.iq'),
      image: '/images/iq-coworking.png'
    },
    {
      name: t('clients.name.dala'),
      image: '/images/dala_qyrandary.svg'
    }
  ];
      ...
      >
        <div className="flex gap-[24px] w-max pr-4 sm:pr-8 md:pr-[34px] pointer-events-none md:pointer-events-auto">
          {clients.map((client, i) => (
            <div key={i} className="bg-white rounded-[32px] p-[32px] w-[300px] min-h-[320px] flex flex-col items-center shrink-0 border border-beigeStrong/50 shadow-sm transition-transform hover:-translate-y-2 hover:shadow-xl select-none">
              {/* Logo Box */}
