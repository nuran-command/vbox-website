...
const translations = {
  ru: {
    ...
    'achievements.quote': '“Наша главная победа - реальная польза людям”',
    'achievements.item.0': 'Победа в номинации Heart of Impact на People & Projects Awards 2025.',
    'achievements.item.1': 'Победа в ProductBee Awards 2025 (креативный бизнес)',
    'achievements.item.2': 'Победа в конкурсе Social Startup Camp 2025 NU Impact Foundation',
    'achievements.item.3': 'Победа в программе MIRAI Министерства иностранных дел Японии.',
    'achievements.item.4': 'Финалисты BI SYNERGY SPRINT 2024 от BI Group — вошли в топ-10 из 200 проектов.',
    'achievements.item.5': 'Финалисты Quick Start XV 2024.',
    ...
    'clients.name.barys': 'Барыс Арена',
    'clients.name.mercedes': 'Mercedes Benz Astana',
    'clients.name.huawei': 'Huawei',
    'clients.name.mechta': 'Mechta.kz',
    'clients.name.sergek': 'Sergek Group',
    'clients.name.nu': 'Nazarbayev University',
    'clients.name.tsarka': 'TSARKA',
    'clients.name.trustme': 'TrustMe',
    'clients.name.technopark': 'Nazarbayev University Technopark',
    'clients.name.iq': 'IQ Coworking',
    'clients.name.dala': 'Дала Кырандары',
    ...
    // Footer
    'footer.copy': '© 2026 VBOX. Все права защищены.',
  ...
  en: {
    ...
    'achievements.quote': '“Our main victory is the real benefit to people”',
    'achievements.item.0': 'Victory in the Heart of Impact nomination at People & Projects Awards 2025.',
    'achievements.item.1': 'Victory in ProductBee Awards 2025 (creative business).',
    'achievements.item.2': 'Victory in the Social Startup Camp 2025 competition by NU Impact Foundation.',
    'achievements.item.3': 'Victory in the MIRAI program by the Ministry of Foreign Affairs of Japan.',
    'achievements.item.4': 'Finalists of BI SYNERGY SPRINT 2024 by BI Group — entered top-10 out of 200 projects.',
    'achievements.item.5': 'Finalists of Quick Start XV 2024.',
    ...
    'clients.name.barys': 'Barys Arena',
    'clients.name.mercedes': 'Mercedes Benz Astana',
    'clients.name.huawei': 'Huawei',
    'clients.name.mechta': 'Mechta.kz',
    'clients.name.sergek': 'Sergek Group',
    ...
    'clients.name.technopark': 'Nazarbayev University Technopark',
    'clients.name.iq': 'IQ Coworking',
    'clients.name.dala': 'Dala Qyrandary',
    ...
    // Footer
    'footer.copy': '© 2026 VBOX. All rights reserved.',
