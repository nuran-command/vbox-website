      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8">
          ...
          <div className="flex items-center gap-4">
            <a href="https://www.instagram.com/vbox_social_startup/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#FFB347] via-[#FF3D77] to-[#833AB4] flex items-center justify-center transition-transform hover:scale-110">
            ...
            <a href="https://t.me/vbox24" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-[#229ED9] flex items-center justify-center transition-transform hover:scale-110">
            ...
            <a href="https://go.2gis.com/xMsmM" target="_blank" rel="noopener noreferrer" className="w-10 h-10 transition-transform hover:scale-110">
